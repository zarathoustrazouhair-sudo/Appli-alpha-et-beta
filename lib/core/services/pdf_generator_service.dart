            ...
            children: [
              ...
              pw.Row(
                ...
                children: [
                  ...
                  pw.Text(
                    "Total Trésorerie: ${users.fold(0.0, (sum, u) => sum + (u.balance as num)).toStringAsFixed(2)} DH",
        ...
        build: (context) {
          return pw.Column(
            ...
            children: [
              ...
              pw.Text(
                "À l'attention de M./Mme $residentName",
                style: pw.TextStyle(fontSize: 16),
              ),
              pw.SizedBox(height: 20),
              pw.Paragraph(
                text:
                    "Sauf règlement de votre part sous un délai de $delayDays jours, le dossier sera transmis au $_jurisdiction pour recouvrement forcé.",
              ),
              pw.SizedBox(height: 10),
              pw.Text(
                "Montant impayé (Cotisations Fixes) : $debtAmount DH",
                style: pw.TextStyle(
                  fontWeight: pw.FontWeight.bold,
                  color: PdfColors.red,
                ),
